# Microservicio Proveedores — CRUD (FastAPI + PostgreSQL)

## Descripción General
Este microservicio, desarrollado con **Python 3.11** y **FastAPI**, implementa operaciones **CRUD** sobre proveedores, incluyendo creación, lectura y validación de datos. El módulo principal `crud.py` encapsula la lógica de negocio, interactuando con SQLAlchemy y modelos Pydantic.
...
```bash
git clone https://github.com/tuusuario/proveedores.git
cd proveedores
```
...
```bash
DATABASE_URL=postgresql://postgres\:postgres@localhost:5432/proveedores
...
El workflow ubicado en `.github/workflows/proveedores-ci.yml`:
...
Microservicio: *Proveedores (CRUD con FastAPI y PostgreSQL)*
