...
class AppIcons {
  ...
  static IconData lock = LucideIcons.lock;
  static IconData eye = LucideIcons.eye;
  static IconData eyeOff = LucideIcons.eyeOff;
  static IconData building = LucideIcons.building;
  static IconData phone = LucideIcons.phone;
  static IconData pin = LucideIcons.mapPin;
  static IconData main = LucideIcons.pill;
  static IconData notification = LucideIcons.bell;
  static IconData clients = LucideIcons.users;
  static IconData lightbulb = LucideIcons.lightbulb;
...
class AppStyles {
  ...
  static Color green1 = Color(0xFF00a63e);
